...
public class SkillService {
    ...
    public ResultPaginationDTO fetchSkillsByCreatedBy(String username, Pageable pageable) {
        Specification<Skill> spec = (root, query, criteriaBuilder) -> criteriaBuilder.equal(root.get("createdBy"),
                username);

        return this.fetchAllSkills(spec, pageable);
    }
