...
import vn.hieu.jobhunter.domain.Subscriber;
import vn.hieu.jobhunter.domain.response.email.ResEmailJob;
import vn.hieu.jobhunter.repository.JobRepository;
import vn.hieu.jobhunter.repository.SkillRepository;
import vn.hieu.jobhunter.repository.SubscriberRepository;
